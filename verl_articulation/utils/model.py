...
from verl_articulation.models.registry import ModelRegistry
...
def normalize_model_name(name, pp_rank, vpp_rank, transformer_config, layer_name="layers"):
    ...
    """
    from verl_articulation.utils.megatron_utils import get_transformer_layer_offset
...
def _load_hf_model(config, model_config, is_value_model, local_cache_path):
    ...
    from verl_articulation.models.mcore.saver import _megatron_calc_global_rank
...
def load_megatron_model_weights(
    ...
    from verl_articulation.models.weight_loader_registry import get_weight_loader
...
def load_megatron_gptmodel_weights(
    ...
    from verl_articulation.models.mcore.loader import load_state_dict_to_megatron_gptmodel
...
def load_mcore_dist_weights(parallel_model, dist_weight_path, is_value_model=False):
    ...
    from verl_articulation.utils.megatron_utils import unwrap_model
...
def get_parallel_gptmodel_from_config(
    ...
    if post_process and value:
        from verl_articulation.models.llama.megatron.layers.parallel_linear import LinearForLastLayer
