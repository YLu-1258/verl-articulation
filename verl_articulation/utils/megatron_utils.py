...
import verl_articulation.utils.megatron.tensor_parallel as tp_utils
from verl_articulation.utils.device import get_device_id, get_device_name, get_torch_device
from verl_articulation.utils.fs import local_mkdir_safe
from verl_articulation.utils.model import normalize_model_name
...
def make_megatron_module(
    ...
    if bridge is not None:
        from verl_articulation.models.mcore.mbridge import freeze_moe_router, make_value_model
        ...
        def megatron_model_provider(pre_process, post_process, vp_stage=None):
            from verl_articulation.models.mcore import init_mcore_model
...
def mcore_model_parallel_config(
    ...
    # Please use hf_to_mcore_config_dense() from verl_articulation.models.mcore.config_converter instead.
    warnings.warn(
        "Code should not reach this point. This function is deprecated and will be removed. Please use "
        "hf_to_mcore_config_dense() from verl_articulation.models.mcore.config_converter instead.",
        DeprecationWarning,
        stacklevel=2,
    )
