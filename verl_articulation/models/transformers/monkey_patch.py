...
from verl_articulation.utils.import_utils import is_trl_available
...
def patch_forward_with_backends(
    ...
    if model.config.model_type == "qwen2_5_vl":
        from verl_articulation.models.transformers.qwen2_5_vl import forward_with_torch_backend, forward_with_triton_backend
        ...
        from verl_articulation.models.transformers.qwen2_vl import forward_with_torch_backend, forward_with_triton_backend

        forward_with_torch_backend_function = forward_with_torch_backend
        forward_with_triton_backend_function = forward_with_triton_backend
    else:
        from verl_articulation.models.transformers.dense_common import forward_with_torch_backend, forward_with_triton_backend
...
def apply_monkey_patch(
    ...
    if model.config.model_type == "qwen2_5_vl":
        ...
        if use_remove_padding or ulysses_sp_size > 1:
            from verl_articulation.models.transformers.qwen2_vl import ulysses_flash_attn_forward
        ...
        if use_remove_padding or ulysses_sp_size > 1:
            ...
            from verl_articulation.models.transformers.kimi_vl import _ulysses_flash_attn_forward
