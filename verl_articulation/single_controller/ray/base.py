...
from verl_articulation.protocol import DataProto, _padding_size_key
from verl_articulation.single_controller.base import ClassWithInitArgs, ResourcePool, Worker, WorkerGroup
from verl_articulation.single_controller.base.decorator import MAGIC_ATTR, Dispatch
from verl_articulation.utils.py_functional import temp_env_var
    ...
    class WorkerDict(worker_cls):
        def __init__(self):
            ...
            for key, user_defined_cls in cls_dict.items():
                ...
                # in worker class, e.g. <verl_articulation.single_controller.base.worker.Worker>
