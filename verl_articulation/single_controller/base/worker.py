...
from verl_articulation.utils.device import get_torch_device, get_visible_devices_keyword
...
class Worker(WorkerHelper):
    ...
    def _configure_before_init(self, register_center_name: str, rank: int):
        ...
        if rank == 0:
            ...
            if os.getenv("WG_BACKEND", None) == "ray":
                from verl_articulation.single_controller.base.register_center.ray import create_worker_group_register_center
