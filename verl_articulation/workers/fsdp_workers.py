...
from verl_articulation.utils.profiler import DistProfiler, DistProfilerExtension, log_gpu_memory_usage, simple_timer
from verl_articulation.utils.profiler.performance import reduce_timing
from verl_articulation.utils.py_functional import convert_to_regular_types
from verl_articulation.workers.config import FSDPCriticConfig, FSDPEngineConfig
...
class ActorRolloutRefWorker(Worker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        from verl_articulation.utils.model import get_generation_config, print_model_size, update_model_config
        ...
        if role == "actor" and optim_config is not None:
            from verl_articulation.utils.torch_functional import get_constant_schedule_with_warmup, get_cosine_schedule_with_warmup
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if rollout_name == "hf":
            from verl_articulation.workers.rollout import HFRollout
            ...
            from verl_articulation.workers.sharding_manager.fsdp_vllm import FSDPVLLMShardingManager
    ...
    def save_checkpoint(self, local_path, hdfs_path=None, global_step=0, max_ckpt_to_keep=None):
        from verl_articulation.utils.logger import log_with_rank
...
class CriticWorker(Worker, DistProfilerExtension):
    ...
    def _build_critic_model_optimizer(self, config):
        ...
        from verl_articulation.utils.model import load_valuehead_model, print_model_size
        from verl_articulation.utils.torch_dtypes import PrecisionType
    ...
    def init_model(self):
        ...
        from verl_articulation.workers.critic import DataParallelPPOCritic
