...
from verl_articulation.utils.checkpoint.megatron_checkpoint_manager import MegatronCheckpointManager
...
from verl_articulation.utils.megatron_utils import (
    load_megatron_model_to_gpu,
    load_megatron_optimizer,
    offload_megatron_model_to_cpu,
    offload_megatron_optimizer,
)
from verl_articulation.utils.memory_utils import aggressive_empty_cache
from verl_articulation.utils.model import get_hf_model_path, load_mcore_dist_weights, load_megatron_gptmodel_weights
from verl_articulation.utils.profiler import (
    DistProfiler,
...
from verl_articulation.utils.profiler.performance import reduce_timing
from verl_articulation.workers.actor.megatron_actor import MegatronPPOActor
from verl_articulation.workers.config import McoreCriticConfig
from verl_articulation.workers.critic.megatron_critic import MegatronPPOCritic
from verl_articulation.workers.reward_model.megatron.reward_model import MegatronRewardModel
...
class MegatronWorker(Worker):
    def _init_hf_config_and_tf_config(
        ...
        from verl_articulation.models.mcore import hf_to_mcore_config
        from verl_articulation.utils import hf_processor, hf_tokenizer
        from verl_articulation.utils.fs import copy_to_local
        from verl_articulation.utils.model import update_model_config
        ...
        if use_mbridge:
            from verl_articulation.models.mcore.mbridge import AutoBridge
...
class ActorRolloutRefWorker(MegatronWorker, DistProfilerExtension):
    ...
    def _build_model_optimizer(
        ...
        from verl_articulation.utils.megatron.optimizer import (
            get_megatron_optimizer,
            get_megatron_optimizer_param_scheduler,
            init_megatron_optim_config,
        )
        from verl_articulation.utils.megatron_utils import McoreModuleWrapperConfig, make_megatron_module
        from verl_articulation.utils.model import get_generation_config, print_model_size
    ...
    def _build_rollout(self, trust_remote_code=False):
        ...
        if self.config.rollout.name == "vllm":
            ...
            from verl_articulation.workers.sharding_manager.megatron_vllm import MegatronVLLMShardingManager
            ...
            from verl_articulation.workers.sharding_manager.megatron_sglang import MegatronSGLangShardingManager
    ...
    def update_actor(self, data: DataProto):
        ...
        from verl_articulation.utils.megatron.optimizer import get_megatron_last_lr
