...
from verl_articulation.utils.device import get_device_id, get_torch_device
from verl_articulation.utils.megatron.pipeline_parallel import make_batch_generator
from verl_articulation.utils.megatron.tensor_parallel import vocab_parallel_entropy, vocab_parallel_log_probs_from_logits
from verl_articulation.utils.megatron_utils import get_model_config
from verl_articulation.utils.profiler import GPUMemoryLogger
from verl_articulation.utils.profiler.profile import Profiler
...
from verl_articulation.utils.torch_functional import broadcast_dict_tensor
...
class MegatronPPOActor(BasePPOActor):
    def __init__(
        ...
        if self.use_fused_kernels:
            from verl_articulation.models.mcore.model_forward_fused import patch_fused_forward
    ...
    def forward_backward_batch(
        ...
        def forward_step(batch_iter, model):
            ...
            from verl_articulation.models.mcore import get_mcore_forward_fn, get_mcore_forward_fused_fn
