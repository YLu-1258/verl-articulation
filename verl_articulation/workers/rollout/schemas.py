...
from verl_articulation.tools.schemas import OpenAIFunctionToolCall, OpenAIFunctionToolSchema, ToolResponse
...
class AsyncRolloutRequest(BaseModel):
    ...
    def _get_position_ids(
        ...
        if is_qwen2vl:
            from verl_articulation.models.transformers.qwen2_vl import get_rope_index
