...
from verl_articulation.utils.torch_functional import broadcast_dict_tensor, pad_sequence_to_length
from verl_articulation.workers.reward_model.base import BasePPORewardModel
...
class MegatronRewardModel(BasePPORewardModel):
    ...
    def forward_batch(self, data: DataProto, use_dynamic_bsz=False, micro_batch_size=None, max_token_len=None):
        ...
        def forward_step(batch_iter, model):
            ...
            from verl_articulation.models.mcore import get_mcore_forward_fn
