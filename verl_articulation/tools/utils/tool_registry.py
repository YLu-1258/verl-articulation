...
from verl_articulation.tools.schemas import OpenAIFunctionToolSchema
...
async def initialize_mcp_tool(tool_cls, tool_config) -> list:
    from verl_articulation.tools.utils.mcp_clients.McpClientManager import ClientManager
