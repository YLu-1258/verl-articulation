...
from verl_articulation.experimental.dataset.sampler import AbstractSampler
from verl_articulation.trainer.constants_ppo import get_ppo_ray_runtime_env
from verl_articulation.trainer.ppo.ray_trainer import RayPPOTrainer
...
def run_ppo(config) -> None:
    ...
    if (
        ...
        from verl_articulation.utils.import_utils import is_nvtx_available
...
class TaskRunner:
    ...
    def add_actor_rollout_worker(self, config):
        ...
        if config.actor_rollout_ref.actor.strategy in {"fsdp", "fsdp2"}:
            ...
            from verl_articulation.workers.megatron_workers import ActorRolloutRefWorker, AsyncActorRolloutRefWorker
    ...
    def add_critic_worker(self, config):
        ...
        if config.critic.strategy in {"fsdp", "fsdp2"}:
            ...
            if use_legacy_worker_impl in ["auto", "enable"]:
                ...
                from verl_articulation.workers.roles import CriticWorker
            ...
            from verl_articulation.workers.megatron_workers import CriticWorker
    ...
    def init_resource_pool_mgr(self, config):
        ...
        from verl_articulation.trainer.ppo.ray_trainer import ResourcePoolManager
...
def create_rl_dataset(data_paths, data_config, tokenizer, processor, is_train=True):
    ...
    if "custom_cls" in data_config and data_config.custom_cls.get("path", None) is not None:
        ...
        from verl_articulation.utils.dataset.dynamicgen_dataset import DynamicGenDataset
