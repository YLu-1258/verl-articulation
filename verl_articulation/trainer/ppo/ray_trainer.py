...
from verl_articulation.trainer.ppo.reward import compute_reward, compute_reward_async, compute_reward_metrics
from verl_articulation.utils.checkpoint.checkpoint_manager import find_latest_ckpt_path, should_save_ckpt_esi
...
class RayPPOTrainer:
    ...
    def _validate(self):
        ...
        # Add reward metrics for validation
        validation_reward_metrics = compute_reward_metrics(reward_extra_infos_dict)
        # Prefix validation reward metrics with "val-" to distinguish from training metrics
        for key, value in validation_reward_metrics.items():
                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("reward", timing_raw, color="yellow"):
                        ...
                        if self.config.reward_model.launch_reward_fn_async:
                            ...
                            reward_extra_infos_dict = {}  # Will be populated later
                        else:
                    ...
                    with marked_timer("old_log_prob", timing_raw, color="blue"):
                        ...
                        if "rollout_log_probs" in batch.batch.keys():
                            ...
                            from verl_articulation.utils.debug.metrics import calculate_debug_metrics
                    ...
                    with marked_timer("adv", timing_raw, color="brown"):
                        ...
                        if reward_extra_infos_dict:
                            ...
                            # Compute and add reward metrics for logging
                            reward_metrics = compute_reward_metrics(reward_extra_infos_dict)
