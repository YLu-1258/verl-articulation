...
from verl_articulation.utils.import_utils import deprecated
...
class AdvantageEstimator(str, Enum):
    ...
    `verl_articulation.trainer.ppo.core_algos.register` with string name for a custom advantage
    estimator instead.
    """
...
@deprecated("verl_articulation.trainer.ppo.core_algos.compute_policy_loss_vanilla")
