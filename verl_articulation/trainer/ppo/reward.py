...
from verl_articulation.workers.reward_manager.abstract import AbstractRewardManager, RawRewardFn
...
def compute_reward_metrics(reward_extra_infos_dict: dict[str, Any]) -> dict[str, Any]:
    """
    Compute metrics from reward extra info dictionary.
    
    This function takes the extra information returned by reward functions
    (e.g., sub-rewards) and computes statistical metrics for logging.
    
    Args:
        reward_extra_infos_dict: Dictionary containing extra reward information,
                               typically sub-rewards or component scores.
    
    Returns:
        Dictionary of metrics with keys like "reward/{key}/mean", "reward/{key}/max", etc.
    """
    metrics = {}
